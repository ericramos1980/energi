...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        assert_equal(change_addrV["hdkeypath"], "m/44'/19797'/0'/1/0") #first internal child key
        ...
        for i in range(num_hd_adds):
            ...
            assert_equal(hd_info["hdkeypath"], "m/44'/19797'/0'/0/"+str(i+1))
        ...
        change_addr = self.nodes[1].getrawchangeaddress()
        change_addrV= self.nodes[1].validateaddress(change_addr);
        assert_equal(change_addrV["hdkeypath"], "m/44'/19797'/0'/1/1") #second internal child key
        ...
        for _ in range(num_hd_adds):
            ...
            assert_equal(hd_info_2["hdkeypath"], "m/44'/19797'/0'/0/"+str(_+1))
        ...
        assert_equal(keypath.split('/')[:5], ['m','44\'', '19797\'', '0\'', '1'])
