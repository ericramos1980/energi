#!/usr/bin/env python3
# Copyright (c) 2016-2019 The Energi Core developers
...
class WalletDumpTest(BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        self.nodes[0].dumpwallet(tmpdir + "/node0/wallet.unencrypted.dump", self.nodes[0].genauthcode())
        ...
        # Should be a no-op:
        self.nodes[0].keypoolrefill()
        self.nodes[0].dumpwallet(tmpdir + "/node0/wallet.encrypted.dump", self.nodes[0].genauthcode())
