...
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1541375412ULL;// ON
...
static const int64_t SPORK_14_REQUIRE_SENTINEL_FLAG_DEFAULT             = 1545415606ULL;// ON
