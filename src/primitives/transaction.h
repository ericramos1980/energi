...
public:
    ...
    CAmount GetDustThreshold(const CFeeRate &minRelayTxFee) const
    {
        ...
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 1000 atoms per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 atoms.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in atoms)
        // i.e. 182 * 3 = 546 atoms with default -minrelaytxfee = minRelayTxFee = 1000 atoms per kB.
...
public:
    ...
    static const int32_t CURRENT_VERSION=1; // TODO: update 2
