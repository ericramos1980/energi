...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000165e800c2fe8219d");
        ...
        chainTxData = ChainTxData{
            ...
            478700,         // * total number of transactions between genesis and that timestamp
